...
const UserProfileForm = props => {
  const { handleClick, handleSubmit, user } = props
	...
	return (
    <form onSubmit={function(evt) {handleSubmit(evt, user)}}>
      <div className="form-row" >
        <div className="form-group col-sm-12" >
          ...
          <div className="control">
              ...
              <input type="text" name="age" className="form-control" defaultValue={user.age}/>
          </div>
          <div className="control">
          ...
          <div className="control">
              ...
              <textarea type="text" rows="3" name="description" className="form-control" defaultValue={user.description}/>
          </div>
